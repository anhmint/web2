...
<body>
  ...
  <div class="radio-group">
    ...
    <option value="Áo thi đấu" <?= $product['category'] == 'Áo thi đấu' ? 'selected' : '' ?>>Áo thi đấu</option>
    <option value="Giày thể thao" <?= $product['category'] == 'Giày thể thao' ? 'selected' : '' ?>>Giày bóng đá</option>
    <option value="Phụ kiện thể thao" <?= $product['category'] == 'Phụ kiện thể thao' ? 'selected' : '' ?>>Phụ kiện thể thao </option>
</select>
    </div>
