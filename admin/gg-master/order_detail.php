...
// Hiển thị lại thời gian đặt hàng
$order_time = new DateTime($order['order_date']);  // đã là giờ VN
$order['order_date'] = $order_time->format('d-m-Y');

// Tính ngày giao hàng = đặt hàng + 3 ngày
$order_time->modify('+3 days');
$order['delivery_date'] = $order_time->format('d-m-Y');
